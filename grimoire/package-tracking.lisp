...
#+nil(provide-output :failed-to-track-package '("Nie pykło :(."
                                            "Nie udało mi sie sprawdzić :(."
                                            "Coś nie działa."))

#+nil(provide-output :no-package-to-track '("Podaj poprawny numer trackingowy paczki. Póki co, umiem śledzić tylko te w bazie Poczty Polskiej."))
