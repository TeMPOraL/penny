...
;;; NOTE disabled for Penny. Not used. For realz.
...
#+nil(register-matcher :random-frequency
...
#+nil(register-matcher :whats-the-frequency
                  (list (match-score (lambda (input)
                                       (and (directedp input)
...
#+nil(provide-output :unknown-frequency '("Nie znam tej częstotliwości."
                                     "Nie kojarzę..."
                                     "Nie wiem."
                                     "No clue."))
