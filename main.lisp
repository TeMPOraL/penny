...
(defparameter *full-name* "Penny from Stardew Valley")  ;FIXME not exactly sure where it belongs...
...
(defun impersonate-slap (channel user)
  (irc::action alice::*connection* channel (concatenate 'string "slaps " user " with a largemouth bass.")))
